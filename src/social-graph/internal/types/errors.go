...
func NewInternalError(detail string, err error) *ProblemResponse {
	return NewAppError("Internal Server Error", detail, "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.1", http.StatusInternalServerError, err)
}
...
func WriteProblemResponse(w http.ResponseWriter, err *ProblemResponse) {
